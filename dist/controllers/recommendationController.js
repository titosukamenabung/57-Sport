...
export const getMyHistory = async (req, res) => {
    try {
        ...
        const histories = await prisma.recommendationRequest.findMany({
            where: {
                userId,
            },
            include: {
...
// CREATE REQUEST
// ======================================
export const createRecommendationRequest = async (req, res) => {
    try {
...
// DETAIL REQUEST
// ======================================
export const showRecommendation = async (req, res) => {
    try {
...
// ======================================
export const calculateManualRecommendation = async (req, res) => {
    try {
