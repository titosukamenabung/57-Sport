...
export const getMerks = async (req: Request, res: Response) => {
  try {
...
// Menambahkan merk
export const createMerk = async (req: Request, res: Response) => {
  try {
...
export const showMerk = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
...
// Mengupdate merk
export const updateMerk = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
    const { namaMerk } = req.body;
...
// Menghapus merk
export const deleteMerk = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
